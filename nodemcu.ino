...
const char* ssid = "NOMEDAREDE"; // SSID da tua rede
const char* password = "PASSWORD"; // Pass da tua rede
IPAddress ip(192, 168, 1, 1); // IP do aparelho
IPAddress gateway(192, 168, 1, 254); // IP do router
IPAddress subnet(255, 255, 255, 0);
 
int router = 2; // D4 // Pin do Relay
int BInLED = LED_BUILTIN;
...
void loop() {
  ...
  if (request.indexOf("/CODE=") != -1)  {
    if (request.indexOf("/CODE=12345/") != -1)  {
